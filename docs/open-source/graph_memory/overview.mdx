...
2. Configure your AWS credentials with access to your Neptune Analytics resources using [Configuration and credentials precedence](https://docs.aws.amazon.com/cli/v1/userguide/cli-chap-configure.html#configure-precedence).

For example, set the following environment variables:
<CodeGroup>
```bash
